...
#define I2C_CLOCK_SPEED_500KHZ                  (500*1000)
#define I2C_CLOCK_SPEED_600KHZ                  (600*1000)
#define I2C_CLOCK_SPEED_700KHZ                  (700*1000)
#define I2C_CLOCK_SPEED_800KHZ                  (800*1000)
#define I2C_CLOCK_SPEED_900KHZ                  (900*1000)
#define I2C_CLOCK_SPEED_1000KHZ                 (1000*1000)
...
#define IS_I2C_CLOCK_SPEED(SPEED)  (((SPEED) == I2C_CLOCK_SPEED_50KHZ)  || \
                                    ...
                                    ((SPEED) == I2C_CLOCK_SPEED_300KHZ) || \
																		((SPEED) == I2C_CLOCK_SPEED_400KHZ) || \
																		((SPEED) == I2C_CLOCK_SPEED_500KHZ) || \
																		((SPEED) == I2C_CLOCK_SPEED_600KHZ) || \
																		((SPEED) == I2C_CLOCK_SPEED_700KHZ) || \
																		((SPEED) == I2C_CLOCK_SPEED_800KHZ) || \
																		((SPEED) == I2C_CLOCK_SPEED_900KHZ) || \
																		((SPEED) == I2C_CLOCK_SPEED_1000KHZ))
