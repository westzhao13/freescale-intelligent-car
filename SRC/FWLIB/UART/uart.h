...
#define UART0_RX_PA14_TX_PA15  (0x00039E18U) //0 3 0 15 14 0 0 第一个为通道，第二个为时钟通道，第三个为GPIO类型 ，第四为读的口，第五为写的口，
...
#define UART5_RX_E8_TX_E9      (0x0002131DU)
                                    //8 9 4 3 5
...
//中断定义
#define UART_IT_TDRE        (uint16_t)(0)  //DMA或串口发时用到
#define UART_IT_TC          (uint16_t)(1)
#define UART_IT_RDRF        (uint16_t)(2)  //DMA或串口収时用到
